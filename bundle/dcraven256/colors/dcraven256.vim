...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Normal", "cccccc", "383838", "")

    " highlight groups
    call <SID>X("Cursor", "708090", "fffd00", "")
    "CursorIM
    "Directory
    call <SID>X("DiffAdd", "cccccc", "3E6C30", "")
    call <SID>X("DiffChange", "cccccc", "1F4287", "")
    "DiffDelete
    call <SID>X("DiffDelete", "cccccc", "683A48", "")
    "DiffText
    call <SID>X("DiffText", "F1D05F", "132554", "")
    "ErrorMsg
    ...
    call <SID>X("NonText", "addbe7", "383838", "bold")
    call <SID>X("Question", "00ff7f", "", "")
    call <SID>X("Search", "fffd00", "383838", "")
    call <SID>X("SpecialKey", "9acd32", "", "")
    call <SID>X("StatusLine", "c2bfa5", "383838", "reverse")
    ...
    hi Pmenu guibg=darkgrey guifg=lightgrey
    hi PmenuSel guibg=darkgreen
    hi Pmenu ctermbg=darkgrey ctermfg=lightgrey
    hi PmenuSel ctermbg=black
    hi MatchParen ctermbg=NONE guibg=NONE guifg=red ctermfg=red 
    hi SpellBad ctermbg=NONE ctermfg=red
    hi SpellLocal ctermbg=NONE ctermfg=DarkBlue
